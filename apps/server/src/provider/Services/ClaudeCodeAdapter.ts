 ...
 *
 * This service owns Claude Code CLI process semantics and emits
 * Claude Code provider events. It does not perform cross-provider routing, shared
 ...
 */
export class ClaudeCodeAdapter extends ServiceMap.Service<ClaudeCodeAdapter, ClaudeCodeAdapterShape>()(
